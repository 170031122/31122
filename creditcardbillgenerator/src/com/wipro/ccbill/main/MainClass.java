...
public class MainClass 
{
	public static void main(String a[]) 
	{
		try
		{
			...
			monthsTransaction[1]=new Transaction("1111222233334444",formatter.parse("05/02/2016"),"TextTile",12000.0,"DB");
			...
			System.out.println("Toral to be paid:"+ccbill.calculateBillAmount());
		}catch(Exception e) {}
	}
}